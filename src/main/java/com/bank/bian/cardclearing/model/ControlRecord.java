package com.bank.bian.cardclearing.model;
...
/**
 * The BIAN control record for this service domain: "Card Clearing Cycle Operating Session".
 *
 ...
 * to its asset type (Card Clearing Cycle). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Card Clearing Cycle Operating Session";
